...
DATASET_PATH = '/home/ubuntu/xwp/datasets/multi_view_dataset/new/cam12/'
DEBUG = False
...
ann_dir = DATASET_PATH + 'label_2/'
output_dir = DATASET_PATH + 'label_new/'
...
for label_file in ann_list:
    ...
    for ann_ind, txt in enumerate(anns):
        ...
        if  border_x_min< (bbox[0]+bbox[2])/2 <  border_x_max and border_y_min< (bbox[1]+bbox[3])/2 < border_y_max:
            continue
        else:
            f.write(txt)
            #f.write('\n')
