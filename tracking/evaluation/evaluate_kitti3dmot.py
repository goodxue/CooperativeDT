...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path="./evaluation", max_truncation = 0, min_height = -1, max_occlusion = 2, mail=None, cls="car", eval_3diou=True, eval_2diou=False):
