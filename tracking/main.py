...
if __name__ == '__main__':
	...
	save_root = '/home/ubuntu/xwp/datasets/multi_view_dataset/new/fuse_test/cam1cam10'
	det_id2str = {1:'Pedestrian', 2:'Car', 3:'Cyclist'}

	# seq_file_list, num_seq = load_list_from_folder(os.path.join('data/KITTI', result_sha))
	seq_file_list, num_seq = load_list_from_folder('/home/ubuntu/xwp/datasets/multi_view_dataset/new/fuse_test/cam1cam10/label_test_tracking')
