...
if __name__ == '__main__':
    ...
    cam2 = Transform(location=Location(x=-95, y=-110, z=4),rotation=Rotation(pitch=0, yaw=30, roll=0))
    ...
    plot_polygon(polygon2)
    plot_polygon(polygon3)
    #plot_polygon(polygon4)
    plt.show()
    polygon13 = intersect(polygon1, polygon3)
    polygon12 = intersect(polygon1, polygon2)
    polygon23 = intersect(polygon2, polygon3)
    polygon123 = intersect(polygon12, polygon3)
    print(cv2.contourArea(np.array(polygon12).reshape(-1,1,2).astype(np.int32))/cv2.contourArea(np.array(polygon1).reshape(-1,1,2).astype(np.int32)))
    print(cv2.contourArea(np.array(polygon13).reshape(-1,1,2).astype(np.int32))/cv2.contourArea(np.array(polygon1).reshape(-1,1,2).astype(np.int32)))
    #print((cv2.contourArea((np.array(polygon23).reshape(-1,1,2).astype(np.int32)))+cv2.contourArea((np.array(polygon12).reshape(-1,1,2).astype(np.int32)))+cv2.contourArea((np.array(polygon13).reshape(-1,1,2).astype(np.int32))))/(cv2.contourArea(np.array(polygon1).reshape(-1,1,2).astype(np.int32))+cv2.contourArea(np.array(polygon2).reshape(-1,1,2).astype(np.int32))+cv2.contourArea(np.array(polygon3).reshape(-1,1,2).astype(np.int32))))
    #polygon4 = intersect(polygon1, polygon2)
    #img = np.zeros([500,500],np.int8)
    #fov1.caculate_iou(fov2)
    area1  = cv2.contourArea((np.array(polygon1).reshape(-1,1,2).astype(np.int32)))
    area2  = cv2.contourArea((np.array(polygon2).reshape(-1,1,2).astype(np.int32)))
    area3  = cv2.contourArea((np.array(polygon3).reshape(-1,1,2).astype(np.int32)))
    area13 = cv2.contourArea((np.array(polygon13).reshape(-1,1,2).astype(np.int32)))
    area12 = cv2.contourArea((np.array(polygon12).reshape(-1,1,2).astype(np.int32)))
    area23 = cv2.contourArea((np.array(polygon23).reshape(-1,1,2).astype(np.int32)))
    area123 = cv2.contourArea((np.array(polygon123).reshape(-1,1,2).astype(np.int32)))
    print((area12+area13+area23-2*area123)/(area1+area2+area3-2*area123-area12-area13-area23))
